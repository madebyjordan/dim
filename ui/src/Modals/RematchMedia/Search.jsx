...
import { useLazySearchExternalMediaQuery } from "../../api/v1/foundation";

import "./Search.scss";

const SelectRematchSearch = () => {
  const [runSearch] = useLazySearchExternalMediaQuery();
  ...
  }, [mediaType, query, runSearch, setTmdbID, setTmdbResults]);
